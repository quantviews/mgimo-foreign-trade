...
fo_2 %>% arrow::write_parquet('data_processed/fizob_2.parquet', compression = "zstd", compression_level = 5L)
fo_4 %>% arrow::write_parquet('data_processed/fizob_4.parquet', compression = "zstd", compression_level = 5L)
fo_6 %>% arrow::write_parquet('data_processed/fizob_6.parquet', compression = "zstd", compression_level = 5L)
fo_tot %>% mutate(TNVED2 = '0') %>% arrow::write_parquet('data_processed/fizob_total.parquet', compression = "zstd", compression_level = 5L)
