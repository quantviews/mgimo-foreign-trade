...
Вопросы к данным обычным языком: ИИ-ассистент сам обращается к API, собирает нужный срез и отвечает готовыми числами и таблицами. MCP-сервер для подключения агентов сейчас в разработке.
</div>
...
<div class="highlight-item"><strong>Китай</strong><span>Крупнейший партнёр: экспорт энергоносителей и металлов, импорт машин, электроники и транспорта.</span><a href="country_bulletins/china/bulletin_china_pdf.pdf">Свежий выпуск, PDF</a></div>
<div class="highlight-item"><strong>Индия</strong><span>Экспорт почти целиком нефть и нефтепродукты, сальдо с большим перевесом в пользу России.</span><a href="country_bulletins/india/bulletin_india_pdf.pdf">Свежий выпуск, PDF</a></div>
<div class="highlight-item"><strong>Турция</strong><span>Данные собираются напрямую из BI-портала ТУИК на уровне 12-значных товарных кодов.</span><a href="country_bulletins/turkey/bulletin_turkey_pdf.pdf">Свежий выпуск, PDF</a></div>
</div>
