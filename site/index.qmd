...
Готовый адрес [nts.mgimo.ru/mcp](https://nts.mgimo.ru/mcp): подключается по персональному ключу, устанавливать ничего не нужно. Работает с Claude Desktop, Claude Code, Cursor, VS Code и вашими агентами.
</div>
