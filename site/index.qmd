...
Данные напрямую в Excel или Power BI по стандартному протоколу OData: выбираете страны, товары и период — таблица подтягивается и обновляется одной кнопкой, без ручных выгрузок. Личный ключ доступа выдаётся в личном кабинете; тарифы — по объёму запросов.
</div>

</div>

## Доступ по API — данные сразу в ваших инструментах

Для регулярной работы и автоматизации есть программный доступ: данные забираются прямо в Excel, Power BI или собственные скрипты — без ручных выгрузок и копирования.

<div class="feature-grid">

<div class="feature-card">
<strong>Нативно в Excel и BI</strong>
Подключение по стандарту OData: в Excel — «Из веб-канала OData», фильтры по странам, товарам и периодам ставятся мышкой, обновление — кнопкой «Обновить всё». Коды ТН ВЭД сразу с русскими названиями.
</div>

<div class="feature-card">
<strong>Личный кабинет и ключ</strong>
Каждый пользователь получает персональный ключ доступа в личном кабинете и сам управляет им. Доступ выдаётся администратором по ролям.
</div>

<div class="feature-card">
<strong>Тарифы и контроль</strong>
Бесплатный доступ на период пилота; далее — бесплатный уровень с лимитами по числу запросов и расширенные тарифы. Использование каждого пользователя видно в мониторинге.
</div>
