...
В основе проекта — база внешней торговли России, собранная из статистики стран-партнёров и дополненная международными данными для полноты картины. Оперативные и подробные ряды дают три страны — Китай, Индия и Турция; их список мы планируем расширять.
...
У каждой записи сохраняется её источник — видно, из какой страны и базы пришла цифра.
</div>
...
Торговлю обычно измеряют в долларах, но за стоимостью не видно реальных потоков, а цены меняются. Мы восстанавливаем объёмы в натуральном выражении — тонны, штуки, кубометры — и строим по ним индексы на разных уровнях товарных групп. Это позволяет отделить рост цен от роста поставок.
</div>
...
<div class="card-spec">
Товарные коды до 6 знаков, стоимость в долларах, без подробной национальной номенклатуры. Происхождение и проверенность цифры видны не всегда.
</div>
<ul class="card-list">
...
<tr>
<td class="criterion">Единый вид источников</td>
...
<tr>
<td class="criterion">Видно происхождение цифры</td>
...
<p>Расскажите о задаче: какие страны, товары и в каком формате нужны.</p>
