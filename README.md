...
- `docs/merge_processed_data-docs.md` — merge pipeline, структура DuckDB и CLI-аргументы.
- `docs/data_model.md` — целевая модель `unified_trade_data`, `SOURCE`/`TYPE`, справочники и fizob-таблицы.
